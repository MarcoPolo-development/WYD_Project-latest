...
namespace WYDII_MarcoPolo_Launcher {
    ...
    {
        if (!ImGui::Begin("WYDII- Marco'Polo Launcher", p_OPEN, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_AlwaysAutoResize)) {
            ImGui::End();
            return;
        }
        ...
        {
            //  CREATE PROCESS
            if (ImGui::Button("Launch WYDII Global", g_LauncherVariables->BUTTONS))
            {
    ...
    {
        const char* PATH = "CUSTOM\\WYDLan.dll";
